...
<div class="row" style="height: 100%; border-top-color: red; border-top-style: solid;">
	<div class="col-md-4">
                  ...
                  <td >
                    <div>
                      <?php if (!empty($cb['support'])) { ?>
                              <a data-toggle="tooltip" data-placement="bottom" title="Descargar" href="https://nx001.nexter.us-nyc1.upcloudobjects.com/indicator/<?= $cb['name_support'] ?>" download="<?= $cb['name_support'] ?>"><i class="fas fa-file-download fa-2x" ></i><?= $cb['name_support'] ?></a>
                      <?php } ?>                    
                    </div>
                    <div>
                      <?php if (!empty($cb['support1'])) { ?>
                        <a data-toggle="tooltip" data-placement="bottom" title="Descargar" href="https://nx001.nexter.us-nyc1.upcloudobjects.com/indicator/<?=$cb['name_support1'] ?>" download="<?= $cb['name_support1'] ?>"><i class="fas fa-file-download fa-2x" ></i><?= $cb['name_support1'] ?></a>
                    <?php } ?>
                    </div>                  
                  </td>
                </tr>
...
var axis = $('#container23').highcharts().colorAxis[0];
  ...
  function get_table_register(year, ind, table, type){
    $.post( "/indicator/indicator/deleted_records/graphic_reports", { age_id: year, id: ind, type:type })
          .done(function( data ) {
  ...
  function get_graphic_register(age_id, id1, frequency_id, type){
    $.post( "/indicator/indicator/deleted_records/report_graph_filter", { age_id: age_id, id: id1, frequency_id: frequency_id, type:type })
            .done(function( data ) {

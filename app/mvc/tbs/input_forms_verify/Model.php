...
namespace tbs_input_forms_verify;
...
/*----------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------*/
	public function delete($form_id)
	{
		...
		$sql = "
			DELETE FROM tbs_input_forms_verify WHERE form_id = $form_id
		";

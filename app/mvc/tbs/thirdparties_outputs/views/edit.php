...
<?php $created_employee = get_messages('employee'); ?>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		value="<?=$thirdparty_output['request_id']?>" 
		class="populate"
		data-modal="requests"
		data-label="<?=$thirdparty_output['request_id']?>"
		>

		<label for="company_id">Empresa:</label>
		<input 	name="company_id" 
		value="<?=$thirdparty_output['company_id']?>" 
		class="populate"
		data-modal="companies"
		data-label="<?=$thirdparty_output['company']?>"
		>

		<label for="employee_id">Empleado:</label>
		<input 	name="employee_id" 
		value="<?=$thirdparty_output['employee_id']?>" 
		class="populate"
		data-modal="employees"
		data-label="<?=$thirdparty_output['employee']?>"
		>

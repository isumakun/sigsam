...
namespace tbs_transformation_forms_logs;
 ...
 ---------------------------------------------------------------------*/
	public function get_all()
	{
		...
		return $this->db->query("
			...
			SELECT *
			FROM `tbs_transformation_forms_logs`
 ...
 ---------------------------------------------------------------------*/
	public function get_by_form_id($id)
	{
		...
		return $this->db->query("
			...
			FROM `tbs_transformation_forms_logs` AS l
 ...
 ---------------------------------------------------------------------*/
	public function get_last($form_id)
	{
		...
		$sql = "
			...
			FROM
				`tbs_transformation_forms_logs` AS l

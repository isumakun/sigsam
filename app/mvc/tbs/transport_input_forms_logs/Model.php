...
namespace tbs_transport_input_forms_logs;
 ...
 ---------------------------------------------------------------------*/
	public function get_all()
	{
		...
		return $this->db->query("
			...
			SELECT *
			FROM `tbs_transport_input_forms_logs`
 ...
 ---------------------------------------------------------------------*/
	public function get_by_form_id($id)
	{
		...
		$sql = "
			...
			FROM `tbs_transport_input_forms_logs` AS l
			...
			INNER JOIN
				`tbs_transport_input_forms` AS f
				ON
					l.form_id = f.id
 ...
 ---------------------------------------------------------------------*/
	public function create($form_id, $form_state_id)
	{
		...
		$sql = "
			...
			INSERT INTO 
				`tbs_transport_input_forms_logs` 
				(
					`form_id`, 
					`form_state_id`, 
					`created_by`, 
 ...
 ---------------------------------------------------------------------*/
	public function get_last($form_id)
	{
		...
		$sql = "
			...
			FROM
				`tbs_transport_input_forms_logs` AS l

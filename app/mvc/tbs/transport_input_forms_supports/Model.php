...
namespace tbs_transport_input_forms_supports;
 ...
 ---------------------------------------------------------------------*/
	public function create($params)
	{
		...
		$sql = "
			...
			INSERT INTO
				`tbs_transport_input_forms_supports` (
					`form_id`, 
					`details`,
					`file_extension`,
 ...
 ---------------------------------------------------------------------*/
	public function get_by_form_id($form_id)
	{
		...
		return $this->db->query("
			...
			FROM
				`tbs_transport_input_forms_supports` AS ifs
 ...
 ---------------------------------------------------------------------*/
	public function get_by_detail($detail)
	{
		...
		return $this->db->query("
			...
			INNER JOIN
				tbs_transport_input_forms AS tip
				ON
					tip.id = ifs.form_id

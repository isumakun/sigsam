...
Class Datagrid {
	...
	{
		static::$table = "<link href='".BASE_URL."public/vendors/DELDataTables/datatables.css' rel='stylesheet'>";
		static::$table .= "<script src='".BASE_URL."public/vendors/DataTables/datatables.min.js'></script>";

		static::$table .= "<link href='".BASE_URL."public/vendors/DataTables/Buttons-1.3.1/css/buttons.dataTables.min.css' rel='stylesheet'>";
		static::$table .= "<script src='".BASE_URL."public/vendors/DataTables/Buttons-1.3.1/js/dataTables.buttons.min.js'></script>";

		static::$table .= "<script src='".BASE_URL."public/vendors/DataTables/Buttons-1.3.1/js/buttons.html5.min.js'></script>";
		static::$table .= "<script src='".BASE_URL."public/vendors/DataTables/Buttons-1.3.1/js/buttons.flash.min.js'></script>";
	}

	// public static function set_options($model, $method, $params = '', $state_save = 'false', $select = false)
	// {
	...
	// 	if ($select)
	// 	{
	// 		static::$table .= "<script src=".BASE_URL.'public/vendors/DataTables/Select-1.2.2/js/dataTables.select.min.js'."></script>";
	// 	}

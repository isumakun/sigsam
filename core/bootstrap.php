...
if (empty($_SERVER['HTTP_X_REQUESTED_WITH']) OR strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) != 'xmlhttprequest')
{
	...
	{
		if (
			(isset($_SESSION['last']['prefix']) && $_SESSION['last']['prefix'] != $_SESSION['prefix']) 	OR
			($_SESSION['last']['controller']	!= $_SESSION['controller'])	OR
			($_SESSION['last']['method'] 		!= $_SESSION['method'])
		)
		{
			if ($_SESSION['last']['prefix'] != 'public' && $_SESSION['prefix'] != 'public') {
				...
				$_SESSION['penultimate']['uri']			= $_SESSION['last']['uri'];
